...
char tallyarbiter_host[40] = "172.16.40.25";  //IP address of the Tally Arbiter Server
...
void loop() {
 ...
 void checkPowerButton()
 {
   ...
   else if (M5.BtnA.pressedFor(10000))
   {
    M5.Display.fillScreen(BLACK);
      M5.Display.setCursor(0,0);
      M5.Display.setTextColor(WHITE);
      M5.Display.println("Power Down...");
      delay(1000);
...
void updateBrightness() {
  ...
  //StickCP2.Display.ScreenBreath(currentBrightness);
#endif
}
